...
{
    /// <summary>
    /// Represents the response returned after retrieving sale details.
    /// </summary>
    /// <remarks>
    /// This response contains detailed information about the sale, including its
    /// unique identifier, sale number, date, total amount, branch, cancellation status,
    /// associated customer, and the list of sale items.
    /// </remarks>
    public class GetSaleResult
    {
        ...
        /// </summary>
        /// <value>A list of <see cref="GetSaleItemResult"/> objects representing the sale items.</value>
